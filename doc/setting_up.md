<h1>Setting up the Space Palette Pro</h1>
You should have these 5 pieces:
<br>1 - core box with all the electronics
<br>2 - oval controller with 4 Morphs
<br>3 - oval monitor
<br>4 - base boxes
<br>5 - plastic bin with misc. parts
<hr>
...
<hr>
Connect the monitor to the back panel of the core box with 2 cables, one HDMI and one IEC/power.
<br><img width=200 src="../images/setting_up/IMG_0903.jpg">
<hr>
...
<hr>
Plug the headphones into the jacks on the back panel.
<br><img width=200 src="../images/setting_up/IMG_0909.jpg">
<hr>
Plug the female end of a power cord into the male power connection on the back panel.  You may need to use a short extension cable.
<br><img width=200 src="../images/setting_up/IMG_0910.jpg">
<hr>
It should boot up in a few minutes after connecting the power.
<br><img width=200 src="../images/setting_up/IMG_0911.jpg">
<hr>
Normally, you shouldn't need to do anything else, but if there is a problem, you can check on things by sliding out the tiny keyboard and monitor after opening the back panel.  The keyboard has a trackpad on the right side.  You may need to press the blue FN key on the lower left of the keyboard, to wake up the keyboard.  The trackpad should move the mouse, but the cursor may be on the other screens, so you'll have to move it around in order to see it.
<br><img width=200 src="../images/setting_up/IMG_0912.jpg">
<hr>
This is what the back looks like with everything connected.
<br><img width=200 src="../images/setting_up/IMG_0913.jpg">
<hr>
